  ...
  <div class="container">
    <header class="d-flex justify-content-center py-3">
      <ul class="nav nav-pills">
        ...
        <li class="nav-item">
          <router-link to="/UpdateBook" class="nav-link" active-class="active">Update Book</router-link>
        </li>
        <li class="nav-item">
          <router-link to="/GetBookCount" class="nav-link" active-class="active">Get Book Count</router-link>
        </li>
        <li class="nav-item">
          <router-link to="/CountBookAPI" class="nav-link" active-class="active">Get Book API</router-link>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item" v-if="isAuthenticated">
          <button @click="logout" class="nav-link btn btn-link" style="cursor: pointer;">
            Logout
          </button>
        </li>
      </ul>
